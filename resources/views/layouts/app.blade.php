    ...
    <body class="bg-gray-100">
        <header class="p-5 border-b bg-white shadow" >
            <div class="container mx-auto flex justify-between items-center">
                ...
                <!-- Directivas de Laravel in case the user is authenticated -->
                @auth
                <nav class="flex gap-2 items-center">
                        <a href=" {{route('posts.create')}} " class="flex items-center gap-2 bg-white border p-2 text-grey-600 rounded text-sm uppercase font-bold cursor-pointer">
